...
# Versie:       0.2 20190610
# Handleiding : https://github.com/pappavis/Easylab4kids_lessen/tree/master/lesmateriaal/082_ESP8266_kattenvoerder
# todo:         documenteren!

# let op: voor deepsleep om te werken, moet je op Wemos D1 pin D0 en RST met jumper kabel verbinden.

# bijbehorend nodered-flow
# zie https://github.com/pappavis/Easylab4kids_lessen/tree/master/lesmateriaal/082_ESP8266_kattenvoerder/node-red-flows
...
mqtt_server = 'dietpi'
#mqtt_server = '192.168.1.144'    #EXAMPLE IP ADDRESS
...
# Die kern van deze applicatie.
# Wachten op op MQQT-berichten van buiten, en die dan afhandelen.
# bijvb doseren van kattenvoer, of de wachttijd tussen deepsleeps bijwerken.
